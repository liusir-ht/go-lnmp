...
#define CONFIGURE_COMMAND " './configure'  '--prefix=/usr/local/php' '--with-gd' '--with-zlib' '--with-mysql=mysqlnd' '--with-mysqli=mysqlnd' '--with-config-file-path=/usr/local/php' '--enable-fpm' '--enable-mbstring' '--with-jpeg-dir=/usr/lib'"
...
#define PHP_EXTENSION_DIR       "/usr/local/php/lib/php/extensions/no-debug-non-zts-20121212"
...
#define PHP_CONFIG_FILE_PATH    "/usr/local/php"
